...
tellraw @s [" ",{"color":"gray","hover_event":{"action":"show_text","value":["3 Lives, no Life Jam. Lives are only regained via killing other players or using a Soul Charm."]},"text":"ⓘ"},{"color":"gray","text":" Lifesteal: "},{"click_event":{"action":"run_command","command":"/trigger hcrplus_presets_lifesteal set 1"},"color":"green","hover_event":{"action":"show_text","value":[{"text":"Click to activate"}]},"text":"Activated"},{"text":"\n "}]
