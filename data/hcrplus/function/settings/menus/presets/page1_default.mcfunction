...
tellraw @s ["",{"color":"gray","text":" "},{"color":"gray","hover_event":{"action":"show_text","value":["Resets Hardcore Revive+ to the default settings. 1 Life, Soul Charms enabled, Auto Revive off."]},"text":"ⓘ"},{"color":"gray","text":" Reset to Defaults: "},{"click_event":{"action":"run_command","command":"/trigger hcrplus_presets_default set 1"},"color":"green","hover_event":{"action":"show_text","value":[{"text":"Click to activate"}]},"text":"Activated"},{"text":"\n "}]
